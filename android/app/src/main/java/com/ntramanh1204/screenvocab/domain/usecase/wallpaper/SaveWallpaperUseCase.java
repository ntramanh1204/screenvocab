...
public class SaveWallpaperUseCase {

    private final WallpaperRepository wallpaperRepository;

    public SaveWallpaperUseCase(WallpaperRepository wallpaperRepository) {
        this.wallpaperRepository = wallpaperRepository;
    }

    public Completable execute(WallpaperEntity wallpaper) {
        return wallpaperRepository.insertWallpaper(wallpaper);
    }
}
