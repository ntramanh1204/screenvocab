...
public class UpdateWallpaperUseCase {

    private final WallpaperRepository wallpaperRepository;

    public UpdateWallpaperUseCase(WallpaperRepository wallpaperRepository) {
        this.wallpaperRepository = wallpaperRepository;
    }

    public Completable execute(WallpaperEntity wallpaper) {
        return wallpaperRepository.updateWallpaper(wallpaper);
    }
}
